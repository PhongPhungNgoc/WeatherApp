...
public class Main2Activity extends AppCompatActivity {
    ...
    ListView lv;
     ...
     ArrayList<ThoiTiet> arrayListThoiTiets;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onBackPressed(); //Tro ve man hinh truoc
            }
        });
    }
    ...
    private void AnhXa() {
        ...
        arrayListThoiTiets = new ArrayList<ThoiTiet>();
        customAdapter = new CustomAdapter(Main2Activity.this,arrayListThoiTiets);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0; i<jsonArrayList.length(); i++){
                        ...
                        arrayListThoiTiets.add(new ThoiTiet(Day,status,icon,tempMax,tempMin));
                    }
                    customAdapter.notifyDataSetChanged(); // Cap nhat du lieu trong Adapter
